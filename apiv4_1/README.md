...
```go
import apiv4_1 "github.com/jqueuniet/netbox-go/apiv4_1"
```
...
For using other server than the one defined on index 0 set context value `apiv4_1.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), apiv4_1.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `apiv4_1.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), apiv4_1.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `apiv4_1.ContextOperationServerIndices` and `apiv4_1.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), apiv4_1.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), apiv4_1.ContextOperationServerVariables, map[string]map[string]string{
...
## Documentation For Models
 ...
 - [PatchedWritableModuleTypeRequestAirflow](docs/PatchedWritableModuleTypeRequestAirflow.md)
 ...
 - [PatchedWritableWirelessLinkRequestDistanceUnit](docs/PatchedWritableWirelessLinkRequestDistanceUnit.md)
 ...
 - [RackRequestFormFactor](docs/RackRequestFormFactor.md)
 ...
 - [Termination1](docs/Termination1.md)
 - [Token](docs/Token.md)
 ...
 - [WirelessLinkDistanceUnitLabel](docs/WirelessLinkDistanceUnitLabel.md)
 - [WirelessLinkDistanceUnitValue](docs/WirelessLinkDistanceUnitValue.md)
 - [WirelessLinkRequest](docs/WirelessLinkRequest.md)
 - [WirelessLinkRequestDistanceUnit](docs/WirelessLinkRequestDistanceUnit.md)
 - [WirelessRole](docs/WirelessRole.md)
 - [WirelessWirelessLinksListDistanceUnitParameter](docs/WirelessWirelessLinksListDistanceUnitParameter.md)
...
auth := context.WithValue(
		context.Background(),
		apiv4_1.ContextAPIKeys,
		map[string]apiv4_1.APIKey{
