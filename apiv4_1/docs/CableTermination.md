...
`func NewCableTermination(id int32, url string, cable int32, cableEnd End1, terminationType string, terminationId int64, termination interface{}, lastUpdated NullableTime, ) *CableTermination`
