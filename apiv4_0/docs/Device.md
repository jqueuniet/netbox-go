...
`func NewDevice(id int32, url string, deviceType BriefDeviceType, role BriefDeviceRole, site BriefSite, primaryIp NullableBriefIPAddress, lastUpdated NullableTime, ) *Device`
