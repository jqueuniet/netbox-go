...
`func NewFrontPortTemplate(id int32, url string, name string, type_ FrontPortType, rearPort BriefRearPortTemplate, lastUpdated NullableTime, ) *FrontPortTemplate`
