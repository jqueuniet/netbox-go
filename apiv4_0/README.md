...
```go
import apiv4_0 "github.com/jqueuniet/netbox-go/apiv4_0"
```
...
For using other server than the one defined on index 0 set context value `apiv4_0.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), apiv4_0.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `apiv4_0.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), apiv4_0.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `apiv4_0.ContextOperationServerIndices` and `apiv4_0.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), apiv4_0.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), apiv4_0.ContextOperationServerVariables, map[string]map[string]string{
...
## Documentation For Models
 ...
 - [DcimRacksListOuterUnitParameter](docs/DcimRacksListOuterUnitParameter.md)
 ...
 - [ExtrasObjectChangesListActionParameter](docs/ExtrasObjectChangesListActionParameter.md)
 ...
 - [TenancyContactAssignmentsListPriorityParameter](docs/TenancyContactAssignmentsListPriorityParameter.md)
...
auth := context.WithValue(
		context.Background(),
		apiv4_0.ContextAPIKeys,
		map[string]apiv4_0.APIKey{
