...
`func NewFHRPGroupAssignment(id int32, url string, group NestedFHRPGroup, interfaceType string, interfaceId int64, interface_ map[string]interface{}, priority int32, lastUpdated NullableTime, ) *FHRPGroupAssignment`
