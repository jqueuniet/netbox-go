...
`func NewConfigTemplate(id int32, url string, name string, templateCode string, dataPath string, dataFile NestedDataFile, dataSynced NullableTime, lastUpdated NullableTime, ) *ConfigTemplate`
