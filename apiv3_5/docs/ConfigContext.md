...
`func NewConfigContext(id int32, url string, name string, dataPath string, dataFile NestedDataFile, dataSynced NullableTime, data map[string]interface{}, lastUpdated NullableTime, ) *ConfigContext`
