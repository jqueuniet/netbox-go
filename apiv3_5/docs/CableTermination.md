...
`func NewCableTermination(id int32, url string, cable int32, cableEnd End, terminationType string, terminationId int64, termination map[string]interface{}, lastUpdated NullableTime, ) *CableTermination`
