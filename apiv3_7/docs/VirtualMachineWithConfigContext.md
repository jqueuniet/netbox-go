...
`func NewVirtualMachineWithConfigContext(id int32, url string, name string, primaryIp NullableNestedIPAddress, configContext interface{}, lastUpdated NullableTime, ) *VirtualMachineWithConfigContext`
