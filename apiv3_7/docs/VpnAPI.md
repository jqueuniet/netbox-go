...
func main() {
	iKEPolicyRequest := []openapiclient.IKEPolicyRequest{*openapiclient.NewIKEPolicyRequest("Name_example", int32(123), "Mode_example")} // []IKEPolicyRequest | 
...
func main() {
	iKEProposalRequest := []openapiclient.IKEProposalRequest{*openapiclient.NewIKEProposalRequest("Name_example", "AuthenticationMethod_example", "EncryptionAlgorithm_example", "AuthenticationAlgorithm_example", int32(123))} // []IKEProposalRequest | 
...
func main() {
	iPSecProfileRequest := []openapiclient.IPSecProfileRequest{*openapiclient.NewIPSecProfileRequest("Name_example", "Mode_example", *openapiclient.NewNestedIKEPolicyRequest("Name_example"), *openapiclient.NewNestedIPSecPolicyRequest("Name_example"))} // []IPSecProfileRequest | 
...
func main() {
	writableIPSecProfileRequest := *openapiclient.NewWritableIPSecProfileRequest("Name_example", "Mode_example", int32(123), int32(123)) // WritableIPSecProfileRequest | 
...
func main() {
	tunnelTerminationRequest := []openapiclient.TunnelTerminationRequest{*openapiclient.NewTunnelTerminationRequest(*openapiclient.NewNestedTunnelRequest("Name_example"), "Role_example", "TerminationType_example")} // []TunnelTerminationRequest | 
