...
`func NewIPSecProfile(id int32, url string, name string, mode IPSecProfileMode, ikePolicy BriefIKEPolicy, ipsecPolicy BriefIPSecPolicy, lastUpdated NullableTime, ) *IPSecProfile`
